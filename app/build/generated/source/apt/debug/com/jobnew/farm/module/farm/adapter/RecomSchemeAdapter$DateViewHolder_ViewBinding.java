...
public class RecomSchemeAdapter$DateViewHolder_ViewBinding implements Unbinder {
  private RecomSchemeAdapter.DateViewHolder target;

  @UiThread
  public RecomSchemeAdapter$DateViewHolder_ViewBinding(RecomSchemeAdapter.DateViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecomSchemeAdapter.DateViewHolder target = this.target;
