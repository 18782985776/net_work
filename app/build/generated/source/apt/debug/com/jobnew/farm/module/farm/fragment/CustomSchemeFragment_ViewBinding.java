...
public class CustomSchemeFragment_ViewBinding implements Unbinder {
  private CustomSchemeFragment target;

  private View view2131297214;

  @UiThread
  public CustomSchemeFragment_ViewBinding(final CustomSchemeFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CustomSchemeFragment target = this.target;
