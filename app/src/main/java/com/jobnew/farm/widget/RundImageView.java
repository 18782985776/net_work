...
/**
 * Created by wangwenlang on 2017/6/27.
 * title:
 * note:
 */


public class RundImageView extends ImageView {

    //基本的三个构造函数
    public RundImageView(Context context) {
        super(context);
    }

    public RundImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RundImageView(Context context, AttributeSet attrs, int defStyle) {
