...
public class MyFarmPlantingFragment extends BaseRefreshLoadFragment {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                switch (view.getId()) {
                    case R.id.tv_contact:
                        FarmToastUtils.show("联系管家..." + position);
                        break;
                    case R.id.tv_progress:
                        if ("pendingPayment".equals(entity.orderStatus)) {
                            ...
                            intent.putExtra(Constant.ORDER_BODY, "租地种植订单");
                    ...
                    case R.id.tv_farm:
                        ...
                        break;
                    case R.id.tv_look_monitor:
                        FarmToastUtils.show("查看监控");
                        break;
                }
            }
        });
    ...
    private void requestData() {
        ...
        map.put("pageNo", page + "");
        map.put("pageSize", "10");
        PersonMyFarmRepository.getIns().getMyFarmPlantOrder(map)
    ...
    public BaseQuickAdapter getAdapter() {
        mList = new ArrayList<>();
        mAdapter = new MyFarmPlantingAdapter(mList, getActivity(), true);
        return mAdapter;
    }
