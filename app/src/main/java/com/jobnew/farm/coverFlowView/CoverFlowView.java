...
//    private static final float CARD_SCALE = 0.15f;
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, com.missmess.coverflowview.R.styleable.CoverFlowView);

        int totalVisibleChildren = a.getInt(
                com.missmess.coverflowview.R.styleable.CoverFlowView_visibleViews, 3);
...
//                R.styleable.CoverFlowView_reflectionGap, 0);
        ...
        mLoopMode = a.getBoolean(com.missmess.coverflowview.R.styleable.CoverFlowView_loopMode, true);

        mGravity = CoverFlowGravity.values()[a.getInt(
                com.missmess.coverflowview.R.styleable.CoverFlowView_coverflowGravity,
                CoverFlowGravity.CENTER_VERTICAL.ordinal())];

        mLayoutMode = CoverFlowLayoutMode.values()[a.getInt(
                com.missmess.coverflowview.R.styleable.CoverFlowView_coverflowLayoutMode,
...
//    	child.layout(0, 0, ScreenUtil.dp2px(getContext(), 200),ScreenUtil.dp2px(getContext(), 110));
        ...
        float scale;
        scale = 1 - Math.abs(offset) * 0.1f;//这个位置调整缩放
