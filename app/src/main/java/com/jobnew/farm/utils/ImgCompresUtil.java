 ...
 */
public class ImgCompresUtil {
    private static ImgCompresUtil instance = null;
    ...
    private ImgCompresUtil(Context context) {
        this.context = context;
    }

    public static ImgCompresUtil getInstance(Context context) {
        if (instance == null) {
            synchronized (ImgCompresUtil.class) {
                if (instance == null)
                    instance = new ImgCompresUtil(context.getApplicationContext());
            }
        }
        return instance;
    }

    public ImgCompresUtil withListener(CompressListener compressListener) {
...
//        String srcImagePath = getFilePathFromUri(srcImageUri);
    ...
    private String getOutputFileName(String srcFilePath) {
        ...
        File file = new File(Environment.getExternalStorageDirectory().getPath(), "ImgCompresUtil/Images");
        if (!file.exists()) {
            file.mkdirs();
        }
