...
public class AddNewTaskAdapter$DateViewHolder_ViewBinding implements Unbinder {
  private AddNewTaskAdapter.DateViewHolder target;

  @UiThread
  public AddNewTaskAdapter$DateViewHolder_ViewBinding(AddNewTaskAdapter.DateViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AddNewTaskAdapter.DateViewHolder target = this.target;
