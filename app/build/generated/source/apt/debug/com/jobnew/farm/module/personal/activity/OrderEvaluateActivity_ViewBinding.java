...
public class OrderEvaluateActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public OrderEvaluateActivity_ViewBinding(OrderEvaluateActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public OrderEvaluateActivity_ViewBinding(final OrderEvaluateActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    OrderEvaluateActivity target = this.target;
