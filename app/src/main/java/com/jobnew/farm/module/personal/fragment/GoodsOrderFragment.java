...
import com.jobnew.farm.module.personal.activity.FeedBackActivity;
...
public class GoodsOrderFragment extends BaseRefreshLoadFragment {
    ...
    public BaseQuickAdapter getAdapter() {
        ...
        adapter = new MyOrderAdapter(R.layout.item_my_order, dataAll, 3,getActivity());
        return adapter;
    }
