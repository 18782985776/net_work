...
public class RecomSchemeAdapter$PhotoViewHolder_ViewBinding implements Unbinder {
  private RecomSchemeAdapter.PhotoViewHolder target;

  @UiThread
  public RecomSchemeAdapter$PhotoViewHolder_ViewBinding(RecomSchemeAdapter.PhotoViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecomSchemeAdapter.PhotoViewHolder target = this.target;
