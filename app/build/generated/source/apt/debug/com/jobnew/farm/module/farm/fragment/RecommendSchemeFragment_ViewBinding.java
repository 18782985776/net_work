...
public class RecommendSchemeFragment_ViewBinding implements Unbinder {
  private RecommendSchemeFragment target;

  private View view2131297214;

  @UiThread
  public RecommendSchemeFragment_ViewBinding(final RecommendSchemeFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecommendSchemeFragment target = this.target;
