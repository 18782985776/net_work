...
public class MonitorActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public MonitorActivity_ViewBinding(MonitorActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MonitorActivity_ViewBinding(MonitorActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MonitorActivity target = this.target;
